...
namespace ABO.Web.Extensions
{
    ...
    public class WebUtility
    {
        ...
        public static IList<SelectListItem> ConvertDictionaryToSelectList(Dictionary<string, string> data, bool includeEmptyValue = false)
        {
            var list = new List<SelectListItem>();
            if (includeEmptyValue)
            {
        ...
        /// <summary>
        /// Gets sort direction string from GridSortOptions object.
        /// </summary>
        /// <param name="sort"></param>
        /// <returns></returns>
        public static string GetSortDir(MvcContrib.UI.Grid.GridSortOptions sort)
        {
            return sort.Direction == MvcContrib.Sorting.SortDirection.Ascending ? "ASC" : "DESC";
        }
    }
