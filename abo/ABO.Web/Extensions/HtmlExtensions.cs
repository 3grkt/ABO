...
namespace ABO.Web.Extensions
{
    public static class HtmlExtensions
    {
        ...
        /// <returns></returns>
        public static MvcHtmlString GetPageSizeOptions(this HtmlHelper helper, string name, int selectedValue = 5, object htmlAttributes = null)
        {
        ...
        /// <returns></returns>
        public static MvcHtmlString ReadOnlyTextBoxFor<T, TProperty>(this HtmlHelper<T> helper, Expression<Func<T, TProperty>> expression)
        {
        ...
        /// <returns></returns>
        public static MvcHtmlString ReadOnlyTextBoxFor<T, TProperty>(this HtmlHelper<T> helper, Expression<Func<T, TProperty>> expression, object htmlAttributes)
        {
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ReadOnlyTextBoxFor<T, TProperty>(this HtmlHelper<T> helper, Expression<Func<T, TProperty>> expression, string format, object htmlAttributes)
        {
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ReadOnlyDropDownListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList, object htmlAttributes)
        {
            var dctAttribute = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
        ...
        {
            return EngineContext.Current.Resolve<IPermissionService>().Authorize(permissions);
        }
    }
