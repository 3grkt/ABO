...
namespace ABO.Core.Infrastructure
{
    public class ContainerManager
    {
        ...
        public T Resolve<T>(string key = "", ILifetimeScope scope = null, IEnumerable<Parameter> parameters = null) where T : class
        {
            if (scope == null)
            {
                //no scope specified
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new ABOException("Unkown dependency");
            ...
            throw new ABOException("No contructor was found that had all the dependencies satisfied.");
        }
